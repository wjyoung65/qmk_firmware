...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
...
#else
    DF(CMK), _______, _______, KC_BTN3, KC_BTN2, KC_BTN1, KC_UNDS, KC_0,    KC_DOT,  _______, _______, _______
#endif
  ),
  [SYM] = LAYOUT(
    ...
    DF(CMK), _______, _______, _______, _______, _______, KC_EQL,  KC_LPRN, KC_RPRN, _______, _______, _______
  ),
  [FUN] = LAYOUT(
  ...
  [MOU] = LAYOUT( // mouse
    ...
    DF(CMK), _______, _______, KC_BTN3, KC_BTN2, KC_BTN1, _______, _______, _______, _______, _______, _______
  ),
};
